...
import { MedicoService, CambiarPasswordPayload } from '../../../../core/services/medico.service';
...
export class SeguridadMedicoPage {
  ...
  async cambiar(): Promise<void> {
    ...
    const payload: CambiarPasswordPayload = { contrasena_actual: v.contrasena_actual, contrasena_nueva: v.contrasena_nueva };
